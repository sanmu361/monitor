...
public class MonitorHttpAsyncCallbackExecutor extends HttpAsyncRequestExecutor {
    private static final Logger LOGGER = LoggerFactory.getLogger(MonitorHttpAsyncCallbackExecutor.class);
    private final int liveTime;

    public MonitorHttpAsyncCallbackExecutor(int liveTime) {
        super();
